...
declstruct(Globals::Type) {
  ...
  declstruct(GlobalServerData) {
    ...
    void dumpfunc() {
      ...
      dumpval(x1F4, x1F8, x1FC, x200_float, x244, x248);
      dumpval(x24C, x250, x254, x258, x25C, x260);
      dumpval(x264, x268, x26C, 0x70, x274, x278);
      dumpval(x27C, x280, x284, x288, x28C, x290);
      dumpval(x294, x298, x29C, x2A0, x2A4_float, x2AC);
      dumpval(x2B0, x2B4, x2B8, x2BC, x2D0, x2D4);
      dumpval(x2D8, x2DC, x2E0, x2E4, x2E8, x2EC);
      dumpval(x2F0, x2F4, x2F8, x2FC_float, x330, x334);
      dumpval(x338, x33C, x340, x344, x348, x34C);
      dumpval(x350, x354, x358, x35C, x360, x364);
      dumpval(x368, x36C, x370, x374, x378, x37C);
    }
  };
  structsize(GlobalServerData, 0x380);
